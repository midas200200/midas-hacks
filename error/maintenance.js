(() => {
  const OVERLAY_ID = "midas-maintenance-overlay";
  const STYLE_ID = "midas-maintenance-styles";
  ...
  style.textContent = `
    @keyframes midasMaintenanceFadeIn {
      from {
        opacity: 0;
      }
    ...
    @keyframes midasMaintenanceCardIn {
      from {
        opacity: 0;
    ...
    @keyframes midasMaintenanceFadeOut {
      from {
        opacity: 1;
      }
    ...
    #${OVERLAY_ID} {
      ...
      animation: midasMaintenanceFadeIn 0.5s ease forwards;
    }

    #${OVERLAY_ID}.midas-closing {
      pointer-events: none;
      animation: midasMaintenanceFadeOut 0.45s ease forwards;
    }
    ...
    #${OVERLAY_ID} .midas-card {
      ...
      animation: midasMaintenanceCardIn 0.6s ease forwards;
    }
  ...
  overlay.innerHTML = `
    <div class="midas-card">
      ...
      <div class="midas-message">
        Hacks for this game are temporarily down for bug fixing,
